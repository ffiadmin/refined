...
//Decide which 404 error page to display
	...
	$pageContent = array("<p>As far as unicorns go, we can only tell you <a href=\"http://answers.yahoo.com/question/index?qid=20110530153109AA3rByo\" target=\"_blank\">why they don't exist</a>. On the bright side, we can help you with the missing page mystery: just click the button below and you'll be sure to land on a page which still exists.</p>",
						 "<p>Perhaps if we had <a href=\"http://answers.yahoo.com/question/index?qid=20070511214502AA1c1pz\" target=\"_blank\">four chances instead of three</a> we would have knocked the ball out the park. Fortunately, you can just click the button below to jump to the home plate.</p>",
